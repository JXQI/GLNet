...
with open('train.txt') as f:
    for i in f.readlines():
        ids_train.append(i.strip())
with open('crossvali.txt') as f:
    for i in f.readlines():
        ids_val.append(i.strip())
with open('test.txt') as f:
    for i in f.readlines():
        ids_test.append(i.strip())
...
dataset_train = DeepGlobe(data_path, ids_train, label=True, transform=True)
...
dataset_val = DeepGlobe(data_path, ids_val, label=True)
...
dataset_test = DeepGlobe(data_path, ids_test, label=False)
